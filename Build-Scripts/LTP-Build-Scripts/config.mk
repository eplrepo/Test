...
AR			:= /home/LinuxBenchmarkAutomation/Cross-compiler/bin/arm-buildroot-linux-uclibcgnueabihf-ar
CC			:= /home/LinuxBenchmarkAutomation/Cross-compiler/bin/arm-buildroot-linux-uclibcgnueabihf-gcc
LEX			:= flex
RANLIB			:= /home/LinuxBenchmarkAutomation/Cross-compiler/bin/arm-buildroot-linux-uclibcgnueabihf-ranlib
STRIP			:= /home/LinuxBenchmarkAutomation/Cross-compiler/bin/arm-buildroot-linux-uclibcgnueabihf-strip
YACC			:= bison -y
...
NUMA_LIBS		:= 
SELINUX_LIBS		:= 
TIRPC_CPPFLAGS		:= -I/home/LinuxBenchmarkAutomation/Cross-compiler/arm-buildroot-linux-uclibcgnueabihf/sysroot/usr/include/tirpc
TIRPC_LIBS		:= -ltirpc
KEYUTILS_LIBS		:= 
...
LINUX_VERSION		:= 
LINUX_DIR		:= ${PWD}/../../Linux-Kernel/Linux
